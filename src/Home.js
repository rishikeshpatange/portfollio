...
function Home() {
    ...
    //     }
    //   }
    //   <button type="button" onClick={moon} > {BtnText} </button>
                ...
                <div className="home__content">
                    ...
                    <div className="social__media">
                        <div className="social__mediaIcons">
                            ...
                            <a href="https://www.instagram.com/rishikeshpatange/" target="_blank" rel="noopener noreferrer"><FaInstagram color='black' fontSize='20px' /></a>
                            <a href="https://www.linkedin.com/in/rishikesh-patange-1979251b6" target="_blank" rel="noopener noreferrer" ><FaLinkedinIn color='black' fontSize='20px' /></a>
                            <a href="https://mail.google.com/mail/u/0/#inbox" target="_blank" rel="noopener noreferrer" ><FaEnvelope color='black' fontSize='20px' /></a>
                        </div>
